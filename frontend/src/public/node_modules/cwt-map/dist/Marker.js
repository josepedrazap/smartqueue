...
var Marker = /** @class */ (function (_super) {
    ...
    Marker.prototype.addMarkerToMap = function () {
        var map = this.context.map;
        var _a = this.props, children = _a.children, bitmap = _a.bitmap, lat = _a.lat, lng = _a.lng, styleClass = _a.styleClass, onTap = _a.onTap;
        var marker;
        if (React.Children.count(children) > 0) {
            // if children are provided, we render the provided react
            // code to an html string
            var html = ReactDOMServer.renderToStaticMarkup((React.createElement("div", { className: "dom-marker " + styleClass || '' }, children)));
