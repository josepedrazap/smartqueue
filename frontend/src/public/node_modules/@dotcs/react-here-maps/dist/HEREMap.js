...
var HEREMap = /** @class */ (function (_super) {
    ...
    HEREMap.prototype.componentDidMount = function () {
        ...
        cache_1.onAllLoad(function () {
            var _a = _this.props, appId = _a.appId, appCode = _a.appCode, center = _a.center, hidpi = _a.hidpi, interactive = _a.interactive, secure = _a.secure, zoom = _a.zoom, configureLayers = _a.configureLayers;
            ...
            var theBaseLayer = defaultLayers.normal.map;
            var theLayers = defaultLayers;
            if (typeof configureLayers === "function") {
                var layers = configureLayers(platform);
                if (layers.baseLayer) {
            ...
            var map = new H.Map(_this.hereMapEl.querySelector(".map-container"), theBaseLayer, {
                center: center,
            ...
            if (interactive !== false) {
                ...
                var ui = H.ui.UI.createDefault(map, theLayers);
                _this.setState({
                    behavior: behavior,
                    ui: ui
                });
    ...
    HEREMap.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: function (el) { return (_this.hereMapEl = el); } },
